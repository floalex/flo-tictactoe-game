...
def computer_places_piece(board)
  ...
  WINNING_LINES.each do |line|
    defend_board = two_in_a_row({line[0] => board[line[0]], line[1] => board[line[1]], line[2] => board[line[2]]}, "O")
    if defend_board
  ...
  if attacked == false
    WINNING_LINES.each do |line|
     defend_board = two_in_a_row({line[0] => board[line[0]], line[1] => board[line[1]], line[2] => board[line[2]]}, "X")
      if defend_board
        board[defend_board] = "O"
        break
      end
